...
{console.log(avatar)}
                ...
                <Link to="/home" id="home-nav-link" onClick={onClose}>
                    <button className="relative flex min-h-10 w-40 items-center justify-start gap-3 overflow-hidden rounded-3xl border border-neutral-700 px-4 py-2 cursor-pointer md:w-36">
                ...
                <Link to="/swipes" id="swipes-nav-link" onClick={onClose}>
                    <button className="relative flex min-h-10 w-40 items-center justify-start gap-3 overflow-hidden rounded-3xl border border-neutral-700 px-4 py-2 cursor-pointer md:w-36">
                ...
                <Link to="/messages" id="messages-nav-link" onClick={onClose}>
                    <button className="relative flex min-h-10 w-40 items-center justify-start gap-3 overflow-hidden rounded-3xl border border-neutral-700 px-4 py-2 cursor-pointer md:w-36">
                ...
                <Link to="/requests" id="requests-nav-link" onClick={onClose}>
                    <button className="relative flex min-h-10 w-40 items-center justify-start gap-3 overflow-hidden rounded-3xl border border-neutral-700 px-4 py-2 cursor-pointer md:w-36">
